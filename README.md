# Freee Go API Library

<!-- x-release-please-start-version -->

<a href="https://pkg.go.dev/github.com/stainless-sdks/freee-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/freee-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Freee Go library provides convenient access to the Freee REST API
...
```go
import (
	"github.com/stainless-sdks/freee-go" // imported as freee
)
```
...
```sh
go get -u 'github.com/stainless-sdks/freee-go@v0.0.1'
```
...
client.Users.GetMe(context.TODO(), ...,
	// Override the header
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/freee-go/option).
...
client.Users.GetMe(context.TODO(), option.WithMaxRetries(5))
```
...
response, err := client.Users.GetMe(context.TODO(), option.WithResponseInto(&response))
if err != nil {
	// handle error
}
fmt.Printf("%+v\n", response)
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/freee-go/issues) with questions, bugs, or suggestions.
