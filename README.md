# Zchee Go API Library

<!-- x-release-please-start-version -->

<a href="https://pkg.go.dev/github.com/zchee/freee-go"><img src="https://pkg.go.dev/badge/github.com/zchee/freee-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Zchee Go library provides convenient access to the Zchee REST API
...
```sh
go get -u 'github.com/zchee/freee-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/zchee/freee-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/zchee/freee-go/issues) with questions, bugs, or suggestions.
